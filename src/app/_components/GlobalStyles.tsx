...
const globalStyles = css`
  ...
  @font-face {
    ...
    src:
      url('/fonts/opensaucesans-medium-webfont.woff2') format('woff2'),
  ...
  @font-face {
    font-family: 'Open Sauce';
    src:
      url('/fonts/opensaucesans-regular-webfont.woff2') format('woff2'),
...
const GlobalStyles = <Global styles={globalStyles} key={'global-styles'} />;
