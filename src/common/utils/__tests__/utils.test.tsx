...
jest.mock('@phosphor-icons/react', () => ({
  ArrowsLeftRight: () => <div data-testid="arrows-left-right">ArrowsLeftRight</div>,
...
describe('getTxTypeColor', () => {
  ...
  test('should return undefined for unknown transaction type', () => {
    expect(getTxTypeColor('unknown_type')).toBeUndefined();
  });
});
...
describe('getTxTypeIcon', () => {
  test('should return ArrowsLeftRight icon for token_transfer', () => {
    ...
    render(<>{icon}</>);
    expect(screen.getByTestId('arrows-left-right')).toBeInTheDocument();
  });
