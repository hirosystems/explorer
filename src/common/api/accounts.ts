...
export const fetchBalances =
  (apiServer: string) =>
  async (principal: string): Promise<AddressBalanceResponse> => {
...
export const fetchAccountInfo =
  (apiServer: string) =>
  async (principal: string): Promise<AccountDataResponse> => {
...
export const fetchTransactions =
  (apiServer: string) =>
  async (principal: string, limit?: number): Promise<TransactionResults> => {
...
export const fetchAllAccountData =
  (apiServer: string) =>
  async (options: AllAccountOptionsBase): Promise<AllAccountData> => {
