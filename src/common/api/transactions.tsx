...
export const fetchTx =
  (apiServer: string) =>
  async (txid: Transaction['tx_id']): Promise<FetchTxResponse> => {
...
export const fetchTxList =
  (options: FetchTxListOptions) =>
  async (): Promise<TransactionResults | MempoolTransactionListResponse> => {
...
export const fetchTransaction =
  (apiServer: string) =>
  async (query: string): Promise<FetchTransactionResponse> => {
    if (query.includes('.')) {
