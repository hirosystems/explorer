...
const FontFamilyDemo = () => (
  <Stack align="stretch" spacing={4}>
    ...
    <Text fontFamily="inter">Inter (Body): Stacks Explorer</Text>
    <Text fontFamily="openSauce">Open Sauce (Heading): Stacks Explorer</Text>
    <Text fontFamily="matter">Matter Regular: Stacks Explorer</Text>
    <Text fontFamily="matterMono">Matter Mono Regular: Stacks Explorer</Text>
    <Text fontFamily="instrument">Instrument Sans: Stacks Explorer</Text>
  </Stack>
);
