...
export const StacksSmileyLightIcon = (iconProps: IconProps) => {
  return (
    <Icon {...iconProps} aria-label="Stacks Smiley">
      <svg viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="34" cy="34" r="28" fill="#F7F6F5" />
        <g filter="url(#filter0_b_2985_1872)">
          <circle
            cx="34"
            cy="34"
            r="19.8028"
            stroke="url(#paint0_linear_2985_1872)"
            stroke-width="16.3943"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
        </g>
        <g filter="url(#filter1_b_2985_1872)">
          <circle cx="34.0004" cy="34" r="21.7709" fill="url(#paint1_linear_2985_1872)" />
          <circle
            cx="34.0004"
            cy="34"
            r="13.5737"
            stroke="url(#paint2_linear_2985_1872)"
            stroke-opacity="0.4"
            stroke-width="16.3943"
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <g filter="url(#filter2_b_2985_1872)">
          <circle cx="33.9989" cy="34.0001" r="14.6268" fill="url(#paint3_linear_2985_1872)" />
          <circle
            cx="33.9989"
            cy="34.0001"
            r="7.37684"
            stroke="url(#paint4_linear_2985_1872)"
            stroke-width="14.5"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
        ...
        <defs>
          ...
          >
            ...
            <feComposite
              in2="SourceAlpha"
              operator="in"
              result="effect1_backgroundBlur_2985_1872"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_backgroundBlur_2985_1872"
              result="shape"
            />
          </filter>
          <filter
            id="filter1_b_2985_1872"
            x="2.79421"
            y="2.79384"
            width="62.4121"
            height="62.4123"
